...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $updateQuery = "UPDATE pengunjung SET nama = '$nama', no_hp = '$no_hp', email = '$email' WHERE id = $id";
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top shadow">
  <div class="container-fluid">
    <span class="navbar-brand">Edit Pengunjung</span>
  </div>
</nav>

<!-- Content -->
<div class="content">
  <h2 class="fw-bold mb-4">Edit Pengunjung</h2>
