...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top shadow">
  <div class="container-fluid">
    <span class="navbar-brand">Data Pengunjung</span>
  </div>
</nav>

<!-- Content -->
<div class="content">
  <h2 class="fw-bold mb-4">Pengunjung</h2>
  <a href="tambah.php" class="btn btn-primary mb-4"><i class="fas fa-plus me-2"></i>Tambah Pengunjung</a>
        ...
        <tbody>
          ...
          if (isset($koneksi) && $koneksi) {
            ...
            if ($result->num_rows > 0) {
              ...
              echo "<tr><td colspan='5' class='text-center text-muted'>Belum ada data pengunjung.</td></tr>";
            }
          } else {
            echo "<tr><td colspan='5' class='text-center text-muted'>Koneksi database gagal.</td></tr>";
          }
          ?>
        </tbody>
      </table>
