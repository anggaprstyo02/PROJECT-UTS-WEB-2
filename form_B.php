...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Simpan ke tabel kendaraan dengan pemilik_id
    ...
    $sql_parkir = "INSERT INTO transaksi (kendaraan_id, tanggal, mulai, akhir, keterangan, biaya, area_parkir_id) 
                   VALUES ('$id_kendaraan', CURDATE(), '00:00:00', '01:00:00', 'Parkir di Kampus B', '$biaya', '$area_parkir_id')";
...
<head>
    <meta charset="UTF-8">
    <title>Reservasi Parkir Kampus B</title>
...
<main class="container my-5">
    <div class="col-lg-8 mx-auto">
        ...
        <?php else: ?>
            ...
            <h2 class="mb-4">Form Reservasi Parkir Kampus B</h2>
                ...
                <fieldset class="mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="areaParkir" name="areaParkir" required>
                            ...
                            <?php
                            $area_result = mysqli_query($koneksi, "SELECT id, nama FROM area_parkir WHERE kampus_id = 3");
